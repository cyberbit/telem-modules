return function (api)
    ...
    local BaseAdvancedPeripheralsInputAdapter = api.mintInput('BaseAdvancedPeripheralsInputAdapter')
    ...
    function BaseAdvancedPeripheralsInputAdapter.mintAdapter (type)
        local adapter = api.ObjectModel.class(BaseAdvancedPeripheralsInputAdapter)
        adapter.type = type
